...
:.hgignore:
    ...
    generated by Python (``*.pyc``), Mercurial (``*.orig``, ``*.rej``) or
    distribute (``*.egg-info``) which are not specific to this project. Such
    patterns should be on your default Mercurial ignore list.
