...
""")
        ...
        foo_py.close()
        # Make sure the mtime of the Sphinx input files generated by
        # autosummary in the following run is greater at a precision of 1
        # second than the Sphinx output produced in the previous run.
        time.sleep(1)
        subprocess.call([bin_doc])
